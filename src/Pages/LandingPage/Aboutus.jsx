    ...
    >
      <Box sx={{ marginTop: "2rem", marginBottom: "3rem" }}>
        ...
        <Typography variant="body1" paragraph style={{ fontSize: "15px" }}>
          ...
          <b style={{ fontSize: "20px", fontWeight: "bold" }}> uFam</b> is more
          than just an app;{" "}
          <b style={{ fontSize: "18px", color: "#5a5a84" }}>it's a community</b>
        ...
        <Typography variant="body1" paragraph style={{ fontSize: "15px" }}>
          ...
          <b style={{ fontSize: "20px", fontWeight: "bold" }}> uFam</b> to be a
        ...
        <Typography variant="body1" paragraph style={{ fontSize: "15px" }}>
          ...
          <b style={{ fontSize: "20px", fontWeight: "bold" }}>uFam</b>
          <b style={{ fontSize: "18px", color: "#5a5a84" }}>
            {" "}
